...
namespace solver
{
    ...
    SequentialSolver::SequentialSolver(board::Board && board) :
        Solver(board),
        continueBackTracking(nullptr),
        constraints(board.size())
    {
    ...
    void SequentialSolver::print() const
    {
        constraints.print();
        board.print();
    }

    bool SequentialSolver::checkIfLatinSquare() const
    {
        return board.checkIfLatinSquare();
    }

    bool SequentialSolver::checkValidityWithHints() const
    {
        return board.checkValidityWithHints();
    }

    void SequentialSolver::setContinueBackTrackingPointer(continueBoolPtrT ptr)
    {
        continueBackTracking = ptr;
    }

    void SequentialSolver::setContinueBackTracking(bool value)
    {
    ...
    bool SequentialSolver::getContinueBackTracking() const
    {
        if (continueBackTracking != nullptr)
        {
    ...
    bool SequentialSolver::setConstraint(size_t row, size_t column, board::boardFieldT value, bool conditionally)
    {
        if (conditionally)
    ...
    bool SequentialSolver::setConstraintConditionally(size_t row, size_t column, board::boardFieldT value)
    {
    ...
    bool SequentialSolver::setConstraintUnconditionally(size_t row, size_t column, board::boardFieldT value)
    {
        constraints[row][column].insert(value);
        return true;
    }

    void SequentialSolver::findCluesOfOne(size_t row, size_t column)
    {
    ...
    void SequentialSolver::findCluesOfN(size_t row, size_t column)
    {
    ...
    void SequentialSolver::findHighSkyscrapers1(size_t row, size_t column)
    {
    ...
    void SequentialSolver::findHighSkyscrapers2(size_t row, size_t column)
    {
    ...
    void SequentialSolver::findPhase2Constraints(size_t row, size_t column)
    {
    ...
    void SequentialSolver::setSatisfiedConstraints(size_t row, size_t column)
    {
    ...
    void SequentialSolver::backTracking(std::vector<board::Board> & retVal, size_t level, size_t row, size_t column)
    {
    ...
    std::vector<board::Board> SequentialSolver::backTrackingWithStack()
    {
        std::vector<board::Board> retVal;
        stackT stack;
    ...
    rowAndColumnPairT SequentialSolver::getNextFreeCell(size_t row, size_t column) const
    {
        ...
        rowAndColumnPairT retVal(row, column);
